...
const PAGES = [
  ...
  { path: '/utilities', label: 'Utilities', keywords: 'converter calculator world clock regex password currency units timezone exchange' },
  { path: '/utilities?tab=converter', label: 'Converter', keywords: 'currency units exchange' },
  { path: '/utilities?tab=worldclock', label: 'World Clock', keywords: 'timezone meeting' },
  ...
  { path: '/utilities?tab=regex', label: 'Regex Tester', keywords: 'pattern match test' },
  { path: '/utilities?tab=calculator', label: 'Financial Calculator', keywords: 'loan interest retirement' },
  { path: '/utilities?tab=passwords', label: 'Password Generator', keywords: 'password generate secure random strength' },
  { path: '/lists', label: 'Curated Lists', keywords: 'top accounts follow discover' },
