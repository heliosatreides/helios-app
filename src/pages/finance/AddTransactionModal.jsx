    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-[#0c0c0e] border border-[#1c1c20] rounded-xl p-6 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="tx-amount" className="block text-[#71717a] text-sm mb-1">Amount</label>
            <input
              id="tx-amount"
              type="number"
              step="0.01"
          ...
          <div>
            <label htmlFor="tx-description" className="block text-[#71717a] text-sm mb-1">Description</label>
            <input
              id="tx-description"
              type="text"
              value={description}
          ...
          <div>
            <label htmlFor="tx-category" className="block text-[#71717a] text-sm mb-1">Category</label>
            <select
              id="tx-category"
              value={category}
          ...
          <div>
            <label htmlFor="tx-account" className="block text-[#71717a] text-sm mb-1">Account</label>
            <select
              id="tx-account"
              value={accountId}
          ...
          <div>
            <label htmlFor="tx-date" className="block text-[#71717a] text-sm mb-1">Date</label>
            <input
              id="tx-date"
              type="date"
              value={date}
          ...
          <div>
            <label htmlFor="tx-type" className="block text-[#71717a] text-sm mb-1">Type</label>
            <select
              id="tx-type"
              value={type}
